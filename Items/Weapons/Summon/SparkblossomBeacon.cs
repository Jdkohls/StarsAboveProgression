...
{
    public class SparkblossomBeaconProgression : ModItem
	{
        private int real_id => ModContent.ItemType<StarsAbove.Items.Weapons.Summon.SparkblossomBeacon>();
        public override string Texture => "StarsAbove/Items/Weapons/Summon/SparkblossomBeacon";
		...
		public override void SetDefaults()
		{
			...
			Item.buffType = BuffType<StarsAbove.Buffs.Summon.SparkblossomBeacon.FleetingSparkBuff>(); //The buff added to player after used the item
        ...
        public override void ModifyWeaponDamage(Player player, ref StatModifier damage){
            ...
            float damageMult = 1f +
                ...
                (golem ? 2f : 0f) +
                (cultist ? 2f : 0f) +
                (moonLord ? 2f : 0f); //need to balance these :>
